...
logo=(f"""\033[1;96m      ######## \033[1;96m##     ## \033[1;92m######
 33[1;92m######## \x1b[1;41m\x1b[1;97mTEAM [SH] \x1b[1;0m
...
\033[1;32m=================================================
       .   Author: SULAIMAN ISLAM
          Telegram   : NAI         
          Facebook   : SULAIMAN ISLAM
          Github     : NAI   
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[FREE•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  SUMON IS A BRAND ❤️‍🔥        \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def main():
    ...
    with ThreadPool(max_workers=100) as SHOAIB:
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/SHOAIB-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSHOAIB-AHAMED\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
